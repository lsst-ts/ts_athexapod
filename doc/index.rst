...
.. image:: https://img.shields.io/badge/GitHub-ts_salobjATHexapod-green.svg
    :target: https://github.com/lsst-ts/ts_salobjATHexapod
.. image:: https://img.shields.io/badge/Jenkins-ts_salobjATHexapod-green.svg
    :target: https://tssw-ci.lsst.org/job/LSST_Telescope-and-Site/job/ts_salobjATHexapod/
.. image:: https://img.shields.io/badge/Jira-ts_salobjATHexapod-green.svg
    :target: https://jira.lsstcorp.org/issues/?jql=labels+%3D+ts_salobjATHexapod
.. image:: https://img.shields.io/badge/ts_xml-ts_salobjATHexapod-green.svg
    :target: https://ts-xml.lsst.io/csc_information.html#athexapod
...
* ts_salobj - v5.2.0
* python - 3.7.x
* lsstts/develop-env:salobj4_b55_5
