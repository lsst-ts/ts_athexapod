...
class ATHexapodRemote:
    ...
    def issueCommandThenWait_applyPositionLimits(self, xyMax, zMin, zMax, uvMax, wMin, wMax, timeoutInSeconds = 10):
    ...
    def subscribeEvent_inPosition(self, action):
        ...
        if "event_inPosition" not in self.topicsSubscribedToo:
            self.topicsSubscribedToo["event_inPosition"] = [self.getNextEvent_inPosition, self.eventSubscribers_inPosition]
    ...
    def subscribeEvent_settingsAppliedPositionLimits(self, action):
        ...
        if "event_settingsAppliedPositionLimits" not in self.topicsSubscribedToo:
            self.topicsSubscribedToo["event_settingsAppliedPositionLimits"] = [self.getNextEvent_settingsAppliedPositionLimits, self.eventSubscribers_settingsAppliedPositionLimits]
    ...
    def subscribeEvent_settingsAppliedVelocities(self, action):
        ...
        if "event_settingsAppliedVelocities" not in self.topicsSubscribedToo:
            self.topicsSubscribedToo["event_settingsAppliedVelocities"] = [self.getNextEvent_settingsAppliedVelocities, self.eventSubscribers_settingsAppliedVelocities]
    ...
    def subscribeEvent_settingsAppliedPivot(self, action):
        ...
        if "event_settingsAppliedPivot" not in self.topicsSubscribedToo:
            self.topicsSubscribedToo["event_settingsAppliedPivot"] = [self.getNextEvent_settingsAppliedPivot, self.eventSubscribers_settingsAppliedPivot]
    ...
    def subscribeEvent_positionUpdate(self, action):
        ...
        if "event_positionUpdate" not in self.topicsSubscribedToo:
            self.topicsSubscribedToo["event_positionUpdate"] = [self.getNextEvent_positionUpdate, self.eventSubscribers_positionUpdate]
    ...
    def subscribeEvent_deviceError(self, action):
        ...
        if "event_deviceError" not in self.topicsSubscribedToo:
            self.topicsSubscribedToo["event_deviceError"] = [self.getNextEvent_deviceError, self.eventSubscribers_deviceError]
    ...
    def subscribeEvent_settingsAppliedTcp(self, action):
        ...
        if "event_settingsAppliedTcp" not in self.topicsSubscribedToo:
            self.topicsSubscribedToo["event_settingsAppliedTcp"] = [self.getNextEvent_settingsAppliedTcp, self.eventSubscribers_settingsAppliedTcp]
    ...
    def subscribeEvent_readyForCommand(self, action):
        ...
        if "event_readyForCommand" not in self.topicsSubscribedToo:
            self.topicsSubscribedToo["event_readyForCommand"] = [self.getNextEvent_readyForCommand, self.eventSubscribers_readyForCommand]
    ...
    def subscribeTelemetry_positionStatus(self, action):
        ...
        if "telemetry_positionStatus" not in self.topicsSubscribedToo:
            self.topicsSubscribedToo["telemetry_positionStatus"] = [self.getNextSample_positionStatus, self.telemetrySubscribers_positionStatus]
