from atHexapodConroller.ATHexapodCommands import ATHexapodCommand
from pythonCommunicator.TcpCommunicator import TcpClienEndChar
import time

hexCmd = ATHexapodCommand()

tcpcon = TcpClienEndChar(address='192.168.222.63', port=50000, connectTimeout=2, readTimeout=2, sendTimeout=2, endStr='\n', maxLength = 1024)
